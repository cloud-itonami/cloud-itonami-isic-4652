...
```bash
kbb -M:dev:run     # walk clean orders + the control triple that proves the covered-manufacturer/buyer-category conjunction, plus HARD-hold cases, through the actor
