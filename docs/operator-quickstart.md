# Operator Quickstart — Wholesale of electronic and telecommunications equipment and parts

Shortest path from clone to a verified local dry-run for **ISIC 4652** (`cloud-itonami-isic-4652`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4652.git
cd cloud-itonami-isic-4652
```
...
- Blueprint governor key: `telecom-supply-chain-governor`
- Likely source path: `telecomtrade.governor.cljc`
