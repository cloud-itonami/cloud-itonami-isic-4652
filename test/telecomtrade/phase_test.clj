...
(deftest delivery-dispatch-never-auto-at-any-phase
  (testing "structural invariant: no phase, now or in any future entry, auto-commits a real equipment dispatch"
...
(deftest invoice-settle-never-auto-at-any-phase
  (testing "structural invariant: no phase, now or in any future entry, auto-commits a real invoice settlement"
    (doseq [[n {:keys [auto]}] phase/phases]
...
(deftest phase-3-auto-commits-only-no-capital-risk-ops
  (testing ":order/intake carries no direct capital/sourcing risk -- auto-eligible; it is the ONLY auto-eligible op in this domain"
